...
@section('content')
    <div class="layout-container">
        ...
        <div class="container">
            <span>*Vui lòng cho chúng t biết triệu chứng về cây lúa của bạn bằng cách chọn form dưới đây</span>
            <form class="mt-2">
                ...
                <div class="form-group">
                  <label for="formGroupExampleInput2">Vết Bệnh</label>
                  <select class="custom-select custom-select-lg mb-3">
                    <option selected>Chọn Vết Bệnh</option>
                    <option value="1">One</option>
                    <option value="2">Two</option>
                    <option value="3">Three</option>
                  </select>
                </div>
                <button class="btn btn-success">Chẩn Đoán</button>
            </form>
